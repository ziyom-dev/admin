...
class ProductSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Product
        exclude = ['live', 'site_id', 'purchases', 'views', 'latest_revision', 'live_revision', 'expired', 'expire_at', 'go_live_at', 'last_published_at', 'first_published_at', 'has_unpublished_changes']
        extra_kwargs = {
            'url': {'lookup_field': 'slug'}
        }
